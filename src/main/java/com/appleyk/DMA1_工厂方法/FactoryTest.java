...
public class FactoryTest {
    ...
    public static void main(String[] args) {
        ...
        String seqNo = "1";
        IChat weixin1 = chatFactory1.createChat("WeiXin");
        weixin1.chatting(seqNo);
        IChat qq1     = chatFactory1.createChat("QQ");
        qq1.chatting(seqNo);
        IChat momo = chatFactory1.createChat("MoMo");
        if(momo == null){
        ...
        seqNo = "2";
        IChat weixin2 = chatFactory2.createWeiXinChat();
        weixin2.chatting(seqNo);
        IChat qq2     = chatFactory2.createQQChat();
        qq2.chatting(seqNo);
        ...
        // 3、使用静态工厂模式进行测试
        seqNo = "3";
        IChat weixin3 = ChatFactory3.createWeiXinChat();
        weixin3.chatting(seqNo);
        IChat qq3     = ChatFactory3.createQQChat();
        qq3.chatting(seqNo);
